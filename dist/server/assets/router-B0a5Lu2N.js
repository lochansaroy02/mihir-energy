...
const appCss = "/assets/styles-BGmZf91H.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Mihir Saroy Solar Energy & Services Pvt Ltd" },
      { name: "description", content: "Powering a sustainable future with clean, reliable solar energy solutions. Installation, maintenance, and support across India." },
      { name: "author", content: "Mihir Saroy Solar" },
      { property: "og:title", content: "Mihir Saroy Solar — Powering a Sustainable Future" },
      { property: "og:description", content: "Clean Energy · Brighter Future · Go Solar, Save Energy, Save Tomorrow" },
...
const $$splitComponentImporter = () => import("./index-BYVqjotF.js");
